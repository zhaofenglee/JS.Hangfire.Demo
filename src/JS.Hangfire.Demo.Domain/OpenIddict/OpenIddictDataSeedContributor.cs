...
namespace JS.Hangfire.Demo.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        //MAUI Client
        var mauiClientId = configurationSection["Demo_Maui:ClientId"];
        if (!mauiClientId.IsNullOrWhiteSpace())
        {
            var mauiClientRootUrl = configurationSection["Demo_Maui:RootUrl"]?.Replace("_", "-");
            await CreateApplicationAsync(
                name: mauiClientId!,
                type: OpenIddictConstants.ClientTypes.Public,
                consentType: OpenIddictConstants.ConsentTypes.Implicit,
        ...
        //MAUI Blazor Client
        var mauiBlazorClientId = configurationSection["Demo_MauiBlazor:ClientId"];
        if (!mauiBlazorClientId.IsNullOrWhiteSpace())
        {
            var mauiBlazorClientRootUrl = configurationSection["Demo_MauiBlazor:RootUrl"]?.Replace("_", "-");
            await CreateApplicationAsync(
        ...
        {
            var webPublicRootUrl = configurationSection["Demo_Web_Public:RootUrl"].EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["Demo_Web_Public:ClientSecret"] ?? "1q2w3e*",
                grantTypes: new List<string> //Hybrid flow
                {
                    OpenIddictConstants.GrantTypes.AuthorizationCode, OpenIddictConstants.GrantTypes.Implicit
                },
        ...
        var webPublicTieredClientId = configurationSection["Demo_Web_Public_Tiered:ClientId"];
        if (!webPublicTieredClientId.IsNullOrWhiteSpace())
        {
            var webPublicTieredRootUrl = configurationSection["Demo_Web_Public_Tiered:RootUrl"].EnsureEndsWith('/');
            ...
            await CreateApplicationAsync(
                ...
                secret: configurationSection["Demo_Web_Public_Tiered:ClientSecret"] ?? "1q2w3e*",
                grantTypes: new List<string> //Hybrid flow
                {
                    OpenIddictConstants.GrantTypes.AuthorizationCode, OpenIddictConstants.GrantTypes.Implicit
                },
